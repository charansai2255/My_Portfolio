          ...
          <div className="space-y-6">
            <div className="prose prose-lg prose-invert">
              <p className="text-lg text-zinc-300 leading-relaxed">
                ...
                , passionate about building innovative software solutions using
                Full-Stack Development, Artificial Intelligence, Machine Learning,
                and Blockchain technologies.
              </p>

              <p className="text-lg text-zinc-300 leading-relaxed">
                From blockchain-based identity verification systems and AI-powered
                planning tools to machine learning applications for healthcare and
                car price prediction, I enjoy creating technology that solves
                real-world problems and delivers meaningful impact.
              </p>
              ...
              <p className="text-lg text-zinc-300 leading-relaxed">
                ...
                solved and hands-on experience in React, Next.js, Node.js,
                FastAPI, Python, Machine Learning, and cloud deployment
                platforms, I focus on building scalable, efficient, and
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6">
              <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/5 border border-purple-500/20 backdrop-blur-sm card-hover">
                <div className="text-3xl font-black bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400">
                  7.6
                </div>
              ...
              <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/5 border border-purple-500/20 backdrop-blur-sm card-hover">
                <div className="text-2xl font-black bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400">
                  AI/ML
                </div>
                <div className="text-sm text-zinc-500 mt-1">Specialization</div>
              </div>
            </div>
          </div>
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/5 border border-purple-500/20 backdrop-blur-sm card-hover">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">Graduated</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20">
                  <span className="text-sm font-semibold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400">
                    GPA: 7.6
                  </span>
                </div>
              </div>
